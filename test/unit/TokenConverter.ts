...
async function sendTokens(impersonate: Address, to: Address, tokenAddr: Address, amount: any, admin: SignerWithAddress) {
...
describe('Token Converter', () => {
    ...
    beforeEach(async () => {
        ...
        const TokenConverterFactory = await ethers.getContractFactory(
            'TokenConverter',
            admin
        );
